...
export default function Income() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setErrorMessage("Failed to add income. See console for details.");
  ...
  const fetchIncome = async () => {
    ...
    if (error) {
      ...
      setErrorMessage("Failed to fetch income data.");
    } else {
      setIncomeData(data || []);
    }
  ...
  const handleDelete = async (id: number) => {
    try {
      ...
      setErrorMessage("Failed to delete income.");
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        <Text style={styles.pageTitle}>Income Tracker</Text>
        <Text style={styles.pageSubtitle}>Capture earnings with clean monthly records.</Text>
